      ...
      if (type === 'ethersale') {
        ...
        if (ethereumNode.isEth) {
          ...
          if (process.platform === 'darwin')
            keystorePath += '/Library/Dogethereum/keystore';
          ...
          if (
            ...
            keystorePath += '/.dogethereum/keystore';

          if (process.platform === 'win32')
            keystorePath = `${Settings.appDataPath}\\Dogethereum\\keystore`;
        }
...
ipc.on('mistAPI_requestAccount', e => {
  if (global.mode === 'wallet') {
    ...
    if (e.sender.history[0] === 'https://wallet.dogethereum.net/') {
      createAccountPopup(e);
    } else {
