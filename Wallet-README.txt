...
The Dogethereum wallet, which allows you to create simple and multisig wallets to manage your ether.
...
https://github.com/dogethereumproject/meteor-dapp-wallet/issues

## Repository

The wallet code can be found at  
https://github.com/dogethereumproject/meteor-dapp-wallet

And the binary application code, which wraps the wallet app can be found at  
https://github.com/dogethereumproject/mist/tree/wallet

## Bundling the wallet

To bundle the binaries yourself follow the instructions on the mist#wallet readme  
https://github.com/dogethereumproject/mist/tree/wallet#deployment
